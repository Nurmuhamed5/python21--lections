...
"=========Boolean type=========="
# Булевые типы данных - имеет 2 значения True и False
bool(1) # True 
bool(0) # False
bool(-234) # True
bool('hello') # True
...
"===========None============"
# None - это тип данных одним значением None, которое используется для обозначения пустых значений или отсутствие значений
bool(None) # False
bool('None') # True
...
# is  это проверка н полное соответствие 
